# generate_and_tweet_inf_rnn.py will generate random tweets via rnn and tweet them indefinitely
# note: because of the whole time.sleep() thread blocking issue, none of the print statements will actually print

try:
    debug = True
    if debug:
        print('in generate_and_tweet_inf_rnn.py')
    import time
    ...
    while True:
        line = textgen.generate(return_as_list=True, temperature=[0.2])[0]
